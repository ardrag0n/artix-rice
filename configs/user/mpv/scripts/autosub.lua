...
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
          { '--opensubtitles', 'ar0177417', 'Donkey125!' },
...
mp.add_key_binding('MBTN_FORWARD', 'download_subs', download_subs)
mp.add_key_binding('MBTN_BACK', 'download_subs2', download_subs2)
